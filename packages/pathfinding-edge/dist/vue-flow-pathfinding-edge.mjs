import { defineComponent, computed, useAttrs, openBlock, createBlock, unref, normalizeProps, mergeProps, createElementBlock, Fragment, createElementVNode, normalizeStyle, createCommentVNode } from "vue";
import { Position, useVueFlow, getSimpleBezierPath, BezierEdge, EdgeText } from "@vue-flow/core";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    sourcePosition: { default: Position.Bottom },
    targetPosition: { default: Position.Top },
    label: {},
    labelStyle: { default: () => ({}) },
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return gridPath.value && gridPath.value.length <= 2 ? (openBlock(), createBlock(unref(BezierEdge), normalizeProps(mergeProps({ key: 0 }, { ...props, ...unref(attrs) })), null, 16)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
        createElementVNode("path", {
          style: normalizeStyle({ ..._ctx.style, ...unref(attrs).style }),
          class: "vue-flow__edge-path",
          d: path.value,
          "marker-end": _ctx.markerEnd,
          "marker-start": _ctx.markerStart
        }, null, 12, _hoisted_1$1),
        _ctx.label ? (openBlock(), createBlock(unref(EdgeText), {
          key: 0,
          x: centered.value[1],
          y: centered.value[2],
          label: _ctx.label,
        ...
        }, null, 8, ["x", "y", "label", "label-style", "label-show-bg", "label-bg-style", "label-bg-padding", "label-bg-border-radius"])) : createCommentVNode("", true)
      ], 64));
    };
  }
});
...
export {
  _sfc_main$1 as PathFindingEdge,
  _sfc_main as PerfectArrow
};
